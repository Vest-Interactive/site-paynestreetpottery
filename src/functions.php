...
require_once('modules/Class_post_type.php');
require_once('modules/Contact.ajax.php');

require_once('modules/Signup.shortcode.php');
add_shortcode('signup', 'get_signup');

//Required in order to add a custom-post-type template, add in mod_rewrite for Apache
...
// Prevent FTP Prompt when updating Plugins
